...
if __name__=="__main__":
    ...
    data_path = "output/color.jsonl"
    wrong_path = 'wrong_id.json'
    # task_id = int(sys.argv[1]) 
    # output_path = f"output/color_reproduct.jsonl"
    output_path = f"output/color_reproduct.jsonl"

    reproduct_data = gen_react(data_path, system_prompt_path, planing_prompt_path, user_prompt_path, nonkey_user_prompt_path, output_path, wrong_path)
