...
def parse_block_nonkey(response_text, action):
    ...
    item["action"] = "GoNextPointTool(" + action + ")"
...
if __name__=="__main__":
    ...
    planing_prompt_path = "/home/zml/algorithm/ReactEQA/data/ToolTrajectory/prompts/trajectory/planing_prompt.txt"
    user_prompt_path = "/home/zml/algorithm/ReactEQA/data/ToolTrajectory/prompts/trajectory/attribute/size/size_user_prompt_step_ans.txt"
    nonkey_user_prompt_path = "/home/zml/algorithm/ReactEQA/data/ToolTrajectory/prompts/trajectory/nonkey_user_prompt.txt"
    # data_path = "/mynvme1/EQA-Traj/trajectory.json"
    data_path = "data/data_size.json"
    output_path = "output/size_output_ans_with_plan_nonkey.json"
