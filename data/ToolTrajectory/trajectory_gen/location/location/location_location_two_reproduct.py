...
def load_data(path, wrong_path, output_path):
    ...
    # print('filtered_wrong_data',filtered_wrong_data)
...
if __name__=="__main__":
    ...
    data_path = "output/location_two_revise.jsonl"
    wrong_path = 'location_location_two_wrong.json'
    # task_id = int(sys.argv[1]) 
    # output_path = f"output/color_reproduct.jsonl"
    output_path = f"output/location_location_two_reproduct.json"
