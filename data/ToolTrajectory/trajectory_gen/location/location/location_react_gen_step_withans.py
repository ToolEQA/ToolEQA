...
if __name__=="__main__":
    ...
    user_prompt_path = "prompts/location_user_prompt_step_ans.txt"
    nonkey_user_prompt_path = "prompts/nonkey_user_prompt.txt"
    # data_path = "/mynvme1/EQA-Traj/trajectory.json"
    data_path = "data/data_location.json"
    output_path = "output/location_output_ans_with_plan_nonkey.json"
