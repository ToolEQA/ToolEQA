...
def gen_react(data_path, system_prompt_path, user_prompt_path):
    ...
    for index, item in enumerate(data):
        ...
        user_prompt = user_prompt.replace("<<QUERY>>", question).replace("<<NUM_IMAGES>>", str(len(images)))#.replace("<<ANSWER>>", answer)
        print("============================")
        print(user_prompt)
...
if __name__=="__main__":
    system_prompt_path = "data/ToolTrajectory/prompts/react_system_prompt.txt"
    user_prompt_path = "data/ToolTrajectory/prompts/react_user_prompt.txt"
