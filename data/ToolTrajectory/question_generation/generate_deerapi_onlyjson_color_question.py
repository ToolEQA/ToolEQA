...
if __name__ == "__main__":
    ...
    csv_file_path = 'question_HkseAnWCgqk_color.csv'
    ...
    with open('HkseAnWCgqk_objects_id.json', 'r', encoding='utf-8') as f:
        lines = json.load(f)
